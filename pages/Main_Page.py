# pages/main.py - Complete with Custom Progress Bar
...
<style>
    ...
    .custom-progress-bar {
        height: 8px;
        border-radius: 6px;
        background: linear-gradient(90deg, #4fded8, #8a7bff, #ff6b9d);
...
def show_custom_progress(percentage: float, label: str = "Loading..."):
    """
    Display a custom gradient progress bar
    
    Args:
        percentage: Value between 0 and 100
        label: Text to display below the progress bar
    """
    ...
    <div class="custom-progress-text">
        <span>{label}</span>
        <span class="custom-progress-percentage">{percentage:.1f}%</span>
    </div>
    """
